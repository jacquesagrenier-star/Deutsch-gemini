...
#
# ⚠️ ET L'EPISODE 45 N'EN SERA JAMAIS UN. C'est la seule surprise de la serie ;
...
EPISODES = [
 ...
 (16,"Der erste Arbeitstag","Le premier jour de travail","arbeit_buero","B1",
  ...
  None,
  None),
 (17,"Hier duzen wir uns","Ici on se tutoie","berufe","A2",
 ...
 (18,"Termine und Absprachen","Rendez-vous et accords","arbeit_buero","B1",
  "Organiser une reunion, deplacer un rendez-vous, se mettre d'accord.",
  "Proposer une date, refuser, negocier un delai.",
  None,
  None),
 (19,"Der Sprachkurs","Le cours de langue","schule","A2",
  ...
  None),
 (20,"Die Mitschüler","Les camarades de cours","schule","B1",
  ...
  None,
  None),
 (21,"Das Paket","Le colis","stadt_gebaeude","B1",
  ...
  None),
 (22,"Die Krankenversicherung","L'assurance maladie","gesundheit","B1",
  ...
  None,
  None),
 (23,"Beim Arzt","Chez le médecin","koerperteile","A2",
 ...
 (28,"Die Familie am Telefon","La famille au téléphone","familie","A2",
  ...
  None,
  None),
 (29,"Silvester","Le Nouvel An","feste_feiertage","B1",
  ...
  None),
 (30,"Im Fitnessstudio","À la salle de sport","sport","A2",
 ...
 # ================== ACTE III -- APPARTENIR (31-48) ==================
 # Le Verein. En Allemagne, le `du` arrive avec le club, pas avec le guichet :
 # c'est le decor qui rend le sommet possible. ⚠️ SOMMET A L'EPISODE 45.
 (31,"Der Volleyballverein","Le club de volleyball","sport","B1",
  ...
  None,
  None),
 (32,"Das erste Training","Le premier entraînement","sport","B1",
  ...
  None),
 (33,"Die Vereinssatzung","Les statuts du club","politik_gesellschaft","B1",
 ...
 (35,"Die Verletzung","La blessure","koerperteile","B1",
  ...
  None),
 (36,"Das Wohnzimmer","Le salon","moebel_haushalt","B1",
  ...
  None,
  None),
 (37,"Was ich koche","Ce que je cuisine","kueche_kochen","B1",
  ...
  None),
 (38,"Streit in der Mannschaft","Dispute dans l'équipe","gefuehle_charakter","A2",
  "Deux joueurs s'accrochent. Mark doit prendre parti, ou pas.",
  "Dire son desaccord, calmer, refuser de choisir.",
  None,
  None),
 (39,"Musik am Abend","Musique le soir","musik_kunst","A2",
  ...
  None),
 (40,"Ein Ausflug an den See","Une sortie au lac","natur","A2",
  ...
  None),
 (41,"Die Kollegin aus Kanada","La collègue du Canada","berufe","B1",
  ...
  None),
 (42,"Ein Missverständnis","Un malentendu","gefuehle_charakter","B1",
  ...
  None),
 (43,"Der Wochenmarkt im Frühling","Le marché au printemps","obst_gemuese","B1",
  "Les premieres asperges. Le meme marchand qu'a l'episode 6, un an apres.",
  "Choisir de saison, negocier, raconter une habitude.",
  "Ils se retrouvent la, ou tout a commence. Le marchand les croit ensemble.",
  None),
 (44,"Das Vorstellungsgespräch","L'entretien décisif","arbeit_buero","B2",
  ...
  None,
  None),
 (45,"Sie oder du?","Sie ou du ?","gefuehle_charakter","B1",
  ...
  None),
 (46,"Das erste Du","Le premier « du »","sprache_kommunikation","C1",
  ...
  None),
 (47,"Ein Fest bei Freunden","Une fête chez des amis","feste_feiertage","B1",
  ...
  None),
 (48,"Am Wochenende","Le week-end","freizeit_hobbys","A2",
 ...
 (49,"Zusammenziehen?","Emménager ensemble ?","wohnen","B2",
  ...
  None),
 (50,"Der Handwerker","L'artisan","moebel_haushalt","A2",
 ...
 (51,"Beim Zahnarzt","Chez le dentiste","gesundheit","B1",
  ...
  None,
  None),
 (52,"Die Steuererklärung","La déclaration d'impôts","einkaufen_geld","B2",
  ...
  None,
  None),
 (53,"Mülltrennung","Le tri des déchets","umwelt","A2",
  ...
  "partageable."),
 (54,"Fahrrad statt Auto","Le vélo plutôt que la voiture","umwelt","B1",
  "Il achete un velo d'occasion. Les pistes, les regles, les cyclistes berlinois.",
  "Acheter d'occasion, negocier, defendre une habitude.",
  None,
  None),
 (55,"Der Urlaub an der Ostsee","Les vacances sur la Baltique","reisen_urlaub","B1",
  ...
  None),
 (56,"Tiere im Haus","Des animaux à la maison","tiere","A2",
 ...
 (57,"Der Garten","Le jardin","natur","B1",
 ...
 (58,"Das Fernsehen und die Nachrichten","La télévision et les nouvelles","medien_technologie","B1",
  "Il comprend enfin le journal televise. Et ce qu'il comprend le derange.",
  "Resumer une information, donner un avis, nuancer.",
  None,
  None),
 (59,"Politik am Küchentisch","La politique à la table de cuisine","politik_gesellschaft","A2",
  ...
  None),
 (60,"Ein schwieriges Gespräch","Une conversation difficile","gefuehle_charakter","B2",
  ...
  None),
 (61,"Die Schwiegereltern","Les beaux-parents","familie","B1",
 ...
 (62,"Montreal im Sommer","Montréal en été","familie","A2",
 ...
 (63,"Die Aufenthaltserlaubnis","Le titre de séjour","politik_gesellschaft","B1",
  ...
  None,
  None),
 (64,"Ein neuer Job","Un nouvel emploi","arbeit_buero","B1",
  ...
  None,
  None),
 (65,"Die Universität","L'université","universitaet","A2",
  ...
  None,
  None),
 (66,"Prüfungsangst","La peur de l'examen","schule","B1",
  ...
  None),
 (67,"Der Einbürgerungstest","Le test de naturalisation","politik_gesellschaft","B2",
  ...
  None,
  None),
 (68,"Was ich vermisse","Ce qui me manque","gefuehle_charakter","B1",
  ...
  None),
 (69,"Der Umzug, zum zweiten Mal","Le déménagement, la deuxième fois","wohnen","A2",
  ...
  "Ils emmenagent. Trois ans apres le non de l'episode 49, et il n'a pas redemande.",
  None),
 (70,"Das Fest im Verein","La fête du club","vereinsleben","C1",
  ...
  None),
 (71,"Ein Jahr in Berlin","Une vie à Berlin","zeit_kalender","B1",
