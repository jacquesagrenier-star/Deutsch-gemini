...
| 2026-09-04 | v401 | Barbara | Demandait de pouvoir **revenir au recto** d'une carte retournée, pour revoir le mot. Très utile selon elle, et impossible à ses yeux. | **La fonction existait déjà** : toucher la moitié gauche d'une carte retournée la ramène au recto. Il y avait même un indice — deux flèches grises en bas de la carte. Elle ne l'a pas trouvé, ce qui est la meilleure preuve possible que l'indice ne disait rien. Les deux moitiés portent maintenant un libellé : « ← Revoir le mot » et « Suivante → ». Une fonction qu'on ne découvre pas n'existe pas. |
